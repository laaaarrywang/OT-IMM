...
def test_data_type(name, data_type, x0, x1, flow_config=None, data_dim=None):
    ...
    try:
        ...
        t_mid = torch.tensor(0.5, dtype=torch.float64)
...
if __name__ == "__main__":
    ...
    # Test 1: Vector data
    x0 = torch.randn(2, 10, dtype=torch.float64)
    x1 = torch.randn(2, 10, dtype=torch.float64)
    ...
    # Test 2: MNIST
    x0 = torch.randn(1, 1, 28, 28, dtype=torch.float64)
    x1 = torch.randn(1, 1, 28, 28, dtype=torch.float64)
    results.append(test_data_type(
    ...
    # Test 3: CIFAR-10
    x0 = torch.randn(1, 3, 32, 32, dtype=torch.float64)
    x1 = torch.randn(1, 3, 32, 32, dtype=torch.float64)
    results.append(test_data_type(
    ...
    x0 = torch.randn(1, 3, 128, 128, dtype=torch.float64)
    x1 = torch.randn(1, 3, 128, 128, dtype=torch.float64)
    results.append(test_data_type(
    ...
    x0 = torch.randn(1, 3, 224, 224, dtype=torch.float64)
    x1 = torch.randn(1, 3, 224, 224, dtype=torch.float64)
    results.append(test_data_type(
